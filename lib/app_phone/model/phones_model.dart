class PhonesModel {
  ...
  PhonesModel({this.code, this.message, this.result});
  ...
  Map<String, dynamic> toJson() {
    ...
    if (warehouseStocks != null) {
     // data['warehouseStocks'] =
        //  warehouseStocks!.map((v) => v.toJson()).toList();
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (masterCategories != null) {
      //data['masterCategories'] =
        //  masterCategories!.map((v) => v.toJson()).toList();
    }
    if (tax != null) {
      data['tax'] = tax!.toJson();
    }
...
class Promotions {
  ...
  Promotions.fromJson(Map<String, dynamic> json) {
    ...
    condition = json['condition'] != null
        ...
        : null;
    benefit =
    json['benefit'] != null ? Benefit.fromJson(json['benefit']) : null;
...
class ProductDetail {
  ...
  ProductDetail.fromJson(Map<String, dynamic> json) {
    ...
    attributeSet = json['attributeSet'] != null
        ? AttributeSet.fromJson(json['attributeSet'])
        : null;
    productLine = json['productLine'];
    seoInfo =
    json['seoInfo'] != null ? SeoInfo.fromJson(json['seoInfo']) : null;
...
class AttributeGroups {
  ...
  AttributeGroups(
      {this.id, this.name, this.value, this.priority, this.parentId});
...
class Configurations {
  ...
  Configurations(
      {this.id, this.code, this.name, this.optionType, this.options});
...
class Options2 {
  ...
  Options2({this.label, this.selected, this.sku, this.quantity, this.url});

  Options2.fromJson(Map<String, dynamic> json) {
    label = json['label'];
